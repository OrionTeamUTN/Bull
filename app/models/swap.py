...
class Swap(db.Model):
    ...
    operation_date: datetime = db.Columnn('operation_date', db.DateTime, nullable=False, default=datetime.utcnow()) # fecha actual por default
    ...
    id_wallet_out: int = db.Column('id_wallet_out', db.Integer, nullable=False)
