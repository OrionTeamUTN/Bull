...
class Swap(db.Model):
    ...
    wallet_send = db.relationship('Wallet', uselist=False, primaryjoin="Swap.id_wallet_send == Wallet.id_wallet") 
    wallet_recv = db.relationship('Wallet', uselist=False, primaryjoin="Swap.id_wallet_recv == Wallet.id_wallet")
